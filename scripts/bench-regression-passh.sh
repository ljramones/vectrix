...
BENCH_REGEX='org.dynamisengine.vectrix.bench.GeometryIntersectionBenchmark.rayAabBatch$' \
...
BENCH_REGEX='org.dynamisengine.vectrix.bench.RenderingMathBenchmark.buildSssLut$' \
