...
BENCH_REGEX='org.dynamisengine.vectrix.bench.TransformAabbBenchmark.transformAabbBatch$' \
...
BENCH_REGEX='org.dynamisengine.vectrix.bench.InstanceUploadBenchmark.(instanceUploadMatrix4f|instanceUploadPackedAffine)$' \
