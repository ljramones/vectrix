...
4. CPU skinning baseline: `SkinningKernels.skinLbs4`.
...
## Experimental Paths
1. `SkinningKernels.skinLbs4Vector` remains experimental until it beats `skinLbs4` in repeated constrained/full runs.
...
3. Current Pass C results keep `skinLbs4` as stable skinning baseline.
